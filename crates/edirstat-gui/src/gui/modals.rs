    ...
    for entry_res in entries {
        ...
        if meta.is_dir {
            ...
            while let Some(idx) = current_idx {
                ...
                ctx.cloned_nodes[idx as usize].allocated += meta.allocated;
    ...
    pub(crate) fn refresh_directory_subtrees(&mut self, dir_indices: &[u32]) {
        ...
        std::thread::spawn(move || {
            ...
            for (dir_idx, path_opt) in targets {
                ...
                let old_allocated = cloned_nodes[dir_idx as usize].allocated;
                ...
                while let Some(p_idx) = current_parent {
                    ...
                    p_node.allocated = p_node.allocated.saturating_sub(old_allocated);
                ...
                cloned_nodes[dir_idx as usize].allocated = 0;
                ...
                if let Some(path) = path_opt {
                    ...
                    let new_allocated = cloned_nodes[dir_idx as usize].allocated;
                    ...
                    while let Some(p_idx) = current_parent {
                        ...
                        p_node.allocated += new_allocated;
